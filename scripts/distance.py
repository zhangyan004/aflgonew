...
def distance (name):
  ...
  if distance != -1:
    ...
    if not args.block_info is None:
      fwriteBnameInfo = open(args.block_info, 'a') 
      fwriteBnameInfo.write ("kkkkkkkkkkkkkkkkkkkkk")
# Main function
if __name__ == '__main__':
  ...
  parser.add_argument ('-a', '--block_info', type=str, help="Path to file saving blockname and id.")
